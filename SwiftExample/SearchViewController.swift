...
//  SwiftExample
//
//  Created by Alek Matthiessen on 7/20/20.
   ...
   var counter = 0
    ...
    //                    self.performSegue(withIdentifier: "FDiscoverToSale", sender: self)
      ...
      override func viewDidLoad() {
        ...
        layout.itemSize = CGSize(width: screenWidth, height: screenWidth/0.75)
...
//            self.tabBarController?.selectedIndex = 2
    ...
    //              self.performSegue(withIdentifier: "DiscoverToAdd", sender: self)
                  ...
                  self.performSegue(withIdentifier: "SearchToSale", sender: self)
      ...
      @objc func tapUse(sender: UIButton) {
    ...
    //                }
                    ...
                    cell.tapuse.layer.borderColor = UIColor.white.cgColor
                    cell.tapuse.layer.borderWidth = 2.0
    ...
    //                cell.layer.masksToBounds = true
                                    ...
                                    cell.tapuse.addTarget(self, action: #selector(SearchViewController.tapUse), for: .touchUpInside)

                    
                    if book?.views != nil {

//                        cell.viewslabel.text = book?.views
                      cell.viewslabel.text = "24 Filters"
