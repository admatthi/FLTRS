...
var greekgirl = UIColor(red: 0.97, green: 0.15, blue: 0.47, alpha: 1.00)
...
class DiscoverViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
  ...
  func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
    ...
    case self.titleCollectionView:
      ...
      //
      cell.tapuse.addTarget(self, action: #selector(DiscoverViewController.tapUse), for: .touchUpInside)
